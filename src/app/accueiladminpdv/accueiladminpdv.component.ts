...
validerdmde(){
  if(confirm("Confirmer la demande")){
    ...
    this._adminpdvService.demandeRetrait({montant:this.montant}).subscribe(
...
public validerdeposite(){
  ...
  if(confirm("Confirmer la demande")){
    console.log("je confirme")
    this._adminpdvService.validerDemandeDepot({montant: this.montantdeposit, infocc: JSON.stringify(this.agentcc), infocom: this.modeversement!=undefined?this.modeversement:""})
      .subscribe(
        data => {
          console.log("---------------------------------------");
          console.log(data);
...
// Grophics
  ...
  public barChartLabels2:string[] = ['2006', '2007', '2008', '2009', '2010', '2011', '2012'];
